...
X = io.mmread(f"{dir_name}/{data_name}_X.mtx").astype(float).toarray()
C = np.loadtxt(f"{dir_name}/{data_name}_C.csv", delimiter=',')
...
n, p = X.shape
out = {}
outputfile=f"../output/{data_name}_init_{method}_k{k}.pkl"
